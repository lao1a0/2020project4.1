								...
								<form class="change" action="theditsave.do"  onsubmit="return is_empty()" method="post">
									<table id="table" style="width:800px;">
										...
										<tr>
											<th width="30%">上传者：</th>
											<td width="70%">
												<input  name="sname"  class="input2 Safe" type="text" value="<%=bi.getSname()%>" readonly></input>
											</td>
										</tr>
										<tr>
											<th>课程名：</th>
										        ...
										        "<div class=\"caption\">"+
										            ...
										            "<div class=\"row\">"+
										                "<div class=\"col-xs-12 col-md-6\">"+
										                    "<a class=\"btn btn-success\"  onclick=\"displayWindow()\" href=\"thomework.do?cno="+bi.getCno()+"&sno="+bi.getSno()+"&tno="+bi.getTno()+"\">批改</a>"+
										                "</div>"+
														"<div class=\"col-xs-12 col-md-6\">"+
